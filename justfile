...
copy_assets:
  ...
  @jq '.details.assets = input.details.assets' {{invocation_directory()}}/index.json /home/decoder/dev/katacoda-scenarios/template/index.json > tmp.json && mv tmp.json {{invocation_directory()}}/index.json
